...
1. `regression.diffs`: This file contains the differences between the expected output and the actual output of the regression tests.

3. `regression.out`: This file contains the actual output of the regression tests. It shows the results, error messages, or any other output generated by the test scripts.
...
### Step 2: Update the current extension documents to the new_version:
